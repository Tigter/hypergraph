...
def load_brenda_data():
    ...
    with open("../brenda_07/all/e2noereaction.json", "r") as f:
        ne_data = json.load(f)
    return train_data, valid_data, test_data,ne_data
...
torch.save(graph_info,"../pre_handle_data/brenda_07/brenda_bigger_lhf_no_e_add_edge_type_add_ne_reaction_graph_info.pkl")
torch.save(train_info,"../pre_handle_data/brenda_07/brenda_bigger_lhf_no_e_add_edge_type_add_ne_reaction_train_info.pkl")
