...
def load_data():
    ...
    graph_info = torch.load("/home/tengwei/relation_cl/pre_handle_data/ce_data_new_graph_info.pkl")
    train_info = torch.load("/home/tengwei/relation_cl/pre_handle_data/ce_data_new_train_info.pkl")
