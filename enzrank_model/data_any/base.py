...
train_paire = extract_rows_with_label("../train_data/training_act.csv")
valid_paire = extract_rows_with_label("../train_data/validation_act.csv")
test_paire = extract_rows_with_label("../train_data/test_act.csv")

print("paire数量：",len(train_paire)+len(valid_paire)+len(test_paire))

# 合并3个dict
train_dict.update(valid_dict)
train_dict.update(test_dict)
print("化合物数量：" , len(train_dict))
